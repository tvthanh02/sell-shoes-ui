...
const ProductCard = ({ product }) => {
  ...
  return (
    <div
      className="relative w-full flex flex-col gap-2 py-3 px-3 rounded-lg border border-solid border-[#f1f1f1] overflow-hidden hover:cursor-pointer"
      onClick={() => navigate(`/detail/${productCode}`)}
    >
      <div className="overflow-hidden h-[280px] group">
        <img
